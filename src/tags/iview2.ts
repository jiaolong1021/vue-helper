export default {
  ...
  "Input": {
    "attributes": ["type", "value", "size", "placeholder", "clearable", "disable", "readonly", "maxlength", "icon", "rows", "autosize", "number", "autofocus", "autocomplete", "element-id", "spellcheck", "wrap", 
  ...
  "Radio": { 
    "attributes": ["value", "label", "disabled", "size", "true-value", "false-value", "on-change"], 
    "framework": "iview2",
    "default": ["label"],
    "description": "单选框",
  }, 
  "RadioGroup": { 
    "attributes": ["value", "type", "size", "vertical", "on-change"], 
    "framework": "iview2",
    "description": "单选框组",
  },
  "Checkbox": { 
    "attributes": ["value", "label", "disabled", "indeterminate", "size", "true-value", "false-value", "on-change"], 
    "framework": "iview2",
    "default": ["label"],
    "description": "多选框",
  }, 
  "CheckboxGroup": { 
    "attributes": ["value", "size", "on-change"], 
    "framework": "iview2",
    "description": "多选框组"
  },
  "Switch": { 
    "attributes": ["value", "size", "disabled", "true-value", "false-value", "on-change"], 
    "framework": "iview2", 
  ...
  "Select": { 
    "attributes": ["value", "multiple", "disabled", "clearable", "filterable", "remote", "remote-method", "loading", "loading-text", "label", 
  ...
  "AutoComplete": { 
    "attributes": ["value", "data", "clearable", "disabled", "placeholder", "size", "icon", "filter-method", "placement", "transfer", "element-id", 
    "on-change", "on-select", "on-search", "on-focus", "on-blur"], 
    "framework": "iview2" 
  },
  "Slider": { 
    "attributes": ["value", "min", "max", "step", "disabled", "range", "show-input", "show-stops", "show-tip", "tip-format", "input-size", "on-change", "on-input"], 
    "framework": "iview2" 
  },
  "DatePicker": { 
    "attributes": ["type", "value", "format", "placement", "placeholder", "options", "split-panels", "multiple", "show-week-numbers", "start-date", "confirm", "open", 
  ...
  "TimePicker": { 
    "attributes": ["type", "value", "format", "steps", "placement", "placeholder", "confirm", "open", "size", "disabled", "clearable", "readonly", "editable", "transfer", 
    "element-id", "on-change", "on-open-change", "on-ok", "on-clear"], 
    "framework": "iview2", 
    "description": "slot：无（自定义选择器的显示内容，建议与 open 等参数一起使用，详见示例） " 
  },
  "Cascader": { 
    "attributes": ["data", "value", "render-format", "disabled", "clearable", "placeholder", "trigger", "change-on-select", "size", "load-data", "filterable", "not-found-text", "transfer", "element-id", "on-change", "on-visible-change"], 
    "framework": "iview2" 
  },
  "Transfer": { 
  ...
  "InputNumber": { 
    "attributes": ["max", "min", "value", "step", "size", "disabled", "placeholder", "formatter", "parser", "readonly", "editable", "precision", "element-id", "on-change", "on-focus", "on-blur"], 
    "framework": "iview2" 
  },
  "Rate": { 
    "attributes": ["count", "value", "allow-half", "disabled", "show-text", "clearable", "on-change"], 
    "framework": "iview2" 
  },
  "Upload": { 
  ...
  "ColorPicker": { 
    "attributes": ["value", "disabled", "alpha", "hue", "recommend", "colors", "format", "size", "on-change", "on-active-change", "on-open-change"], 
    "framework": "iview2" 
  },
  "Form": { 
  ...
  "Modal": { 
    "attributes": ["value", "title", "closable", "mask-closable", "loading", "scrollable", "ok-text", "cancel-text", "width", "styles", "class-name", "transition-names", "transfer", "on-ok", "on-cancel", "on-visible-change"], 
    "framework": "iview2", 
  ...
  "Collapse": { 
    "attributes": ["value", "accordion", "on-change"], 
    "framework": "iview2" 
  }, 
  "Panel": { 
    "attributes": ["name"], 
  ...
  "Carousel": { 
    "attributes": ["value", "height", "loop", "autoplay", "autoplay-speed", "dots", "radius-dot", "trigger", "arrow", "easing", "on-change"], 
    "framework": "iview2" 
  },
  "Tree": { 
